...
//        dd($image);
        ...
        \DB::table('products')->insert([
            [
                'fix_prices' => json_encode([
                    'RUB' => '14500',
                ]),
                'barcode'=> '3612940000827',
                'vendor_code'=>'YA20S10P',
                'weight'=>'315',
                ...
                'description' => json_encode([
                    ...
                    'ru' => 'Концепция бренда связана с идеей воплотить аромат в живой персонаж, наделенный характером, историей и визуальным воплощением, подобно литературным героям. На каждом флаконе и этикетке мы видим описание этого персонажа и его интересы.   Aron - загадочный бизнесмен, коллекционер.  У него богатый жизненный опыт, он интересуется  классической музыкой, литературой, а также  археологией и особенно искусством племен. Он спокоен и уверен в себе, вдумчиво ценит  историю и традиции.  Аромат Арона насыщенный и мягкий, созданный  сочетанием самых роскошных и редких нот.  Солнечный шафран, элегантный азиатский уд,  сладкий абрикос и мягкие кожаные ноты османтуса  и сандала. Арон окутывает Вас приятным теплом, создавая  ощущение комфорта, уюта и защищенности.   Верхние ноты: шафран,  абрикос. Средние ноты: уд, замша,  османтус, пачули. Базовые ноты: дубовый мох,  мускус, сандал, ваниль.',
                ]),
                'cost' => rand(150, 300),
            ...
            [
                ...
                'barcode'=> '3612940000834',
                'vendor_code'=>'YGI20S10P',
                'weight'=>'315',
                ...
                'description' => json_encode([
                    ...
                    'ru' => 'Концепция бренда связана с идеей воплотить аромат в живой персонаж, наделенный характером, историей и визуальным воплощением, подобно литературным героям. На каждом флаконе и этикетке мы видим описание этого персонажа и его интересы.   Gideon- мужчина 32 лет с красочными  татуировками на предплечье. Настойчивый характер Гидеона делает его  незабываемым компаньоном, жестоким и  диким. Он свободен и необуздан.  Завоеватель, от которого не хочется убегать.  Первые ощущения от знакомства, как тонкие лезвия меча, рассекающие воздух - бергамот и лаванда,  грейпфрут и озон. Пространство наполнено  горячим воздухом сычуаньского перца, герани, похожими на дыхание дикого зверя. Страстная природа аромата, украшена благородными смолами.  Мы чувствуем  опасность, но не можем ей противостоять. Верхние ноты: бергамот, лаванда,  грейпфрут, озон. Средние ноты: цветы гвоздики,  герань, нарцисс, табак,  сычуаньский перец, кедр, кожа. Базовые ноты: цивет, ирис, мускус,  олибанум, лабданум.',
                ]),
                'cost' => rand(150, 300),
                'cost_dealer' => rand(120, 140),
                'cost_vip_dealer' => rand(70, 120),
            ...
            [
                ...
                'barcode'=> '3612940000810',
                'vendor_code'=>'YRA20S10P',
                'weight'=>'315',
                ...
                'description' => json_encode([
                    ...
                    'ru' => 'Концепция бренда связана с идеей воплотить аромат в живой персонаж, наделенный характером, историей и визуальным воплощением, подобно литературным героям. На каждом флаконе и этикетке мы видим описание этого персонажа и его интересы. RAVENNA  - молодая студентка-искусствовед со светлыми волосами и беспокойным характером.  Под миловидным и миниатюрным обликом она  скрывает кипящее молодостью сердце и  неспокойный нрав. Аромат Ravenna создает ощущение  игривости и кокетства благодаря белоцветочной  основе из соблазнительной туберозы и  молочной гардении, под которой скрываются  оттенки спелого персика, нежного белого  меда и кокоса, а также терпкого кедра и  чувственной замши.  Верхние ноты: тубероза,  гардения, персик.  Средние ноты: франжипани,  белый мед, кокос, кедр, молоко. Базовые ноты: амбра,  мускус, ваниль, замша.',
                ]),
                'cost' => rand(150, 300),
                'cost_dealer' => rand(120, 140),
                'cost_vip_dealer' => rand(70, 120),
            ...
            [
                ...
                'barcode'=> '3612940000803',
                'vendor_code'=>'YW20S10P',
                'weight'=>'315',
                ...
                'description' => json_encode([
                    ...
                    'ru' => 'Концепция бренда связана с идеей воплотить аромат в живой персонаж, наделенный характером, историей и визуальным воплощением, подобно литературным героям. На каждом флаконе и этикетке мы видим описание этого персонажа и его интересы.  WILLIAM -  молодой и талантливый дизайнер. Худощавый высокий юноша, с вьющимися светло - каштановыми волосами. Его интересы: литература, искусство, мода, дизайн. Аромат воспевающий мир дизайна и искусства.  Его элегантность основана на классических  принципах, но его любовь к новому позволяет совершенствоваться. Аромат создан благодаря сочетанию классической  базы - дубовый мох, кедр и пачули с ярким, современным эстрагоном, вермутом  и тюльпаном.  Верхние ноты: эстрагон,  бергамот, тюльпан.  Средние ноты: зеленый чай,  вермут, кедр, пачули. Базовые ноты: дубовый мох,  янтарь, китовая амбра.',
                ]),
                'cost' => rand(150, 300),
                'cost_dealer' => rand(120, 140),
                'cost_vip_dealer' => rand(70, 120),
