            ...
            <div class="flex flex-col sm:ml-12">
                ...
                <div class="flex items-center mt-4">
                    @if ((new \App\Services\Shop\CartService())->checkExists($product->id))
                        ...
                        @endphp
                        <input type="text" id="product_amount_{{$product->id}}" class="border h-10 w-14 text-center outline-none focus:bg-slate-100 duration-200" min="1" max="100" value="{{$cart['cart'][$product->id]}}" onchange="press_btn()">
                    ...
                    @else
                        <input type="text" id="product_amount_{{$product->id}}" class="border h-10 w-14 text-center outline-none focus:bg-slate-100 duration-200" min="1" max="100" value="1">
